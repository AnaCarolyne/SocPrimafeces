        ...
        <div aligan="center">
            ...
            <table>
                <div style="background-color:#1c5d79;top: 0px;">
                    <h1>Relatorio Nome Suprimento com Corrida ${operacao}</h1>
                </div>

                <form id="testForm" action="RelatorioSuprimentoNomeCorridaController" method="post">


                    <tr>
                        <td>Nome Suprimento:</td>
                        <td>
                            <select name="nomeSuprimento" id="nomeSuprimento">
                                    <option value="">Selecione</option>
                                    <option value="MESA">MESA</option>
                                    <option value="CADEIRA">CADEIRA</option>
                                    <option value="CONE">CONE</option>
                                    <option value="CERCA SANDISK">CERCA SANDISK</option>
