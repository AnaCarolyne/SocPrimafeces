...
<html>
    ...
    <body>
        <div aligan="center">
            ...
            <table>
                <table>
                    <div style="background-color:#191970;top: 0px;">
                        <h1>Relatorio Atleta tipo Sanguinio ${operacao}</h1>
                    </div>

                    <form id="testForm" action="RelatorioKitProvaTamanhoController" method="post">


                        <tr>
                            <td>Tipo Sanguinio :</td> 
                            <td> 
