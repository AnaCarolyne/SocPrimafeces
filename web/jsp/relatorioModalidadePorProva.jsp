        ...
        <div aligan="center">
            ...
            <table>
                <div style="background-color:#1c5d79;top: 0px;">
                    <h1>Relatorio Modalidade Por Tipo de Prova ${operacao}</h1>
                </div>

                <form id="testForm" action="RelatorioModalidadePorProvaController" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="tipoProva" id="tipoProva">
                                    ...
                                    <option value="CORRIDA DE TEMPO">CORRIDA DE TEMPO</option>
                                    <option value="CAMINHADA">CAMINHADA</option>
                                    <option value="CORRIDA lONGA">CORRIDA lONGA</option>
