...
<html>
    <SCRIPT language="JavaScript">
        ...
        function validarFormulario(form) {
            ...
            if (!campoNumerico(form.idOrganizador.value)) {
    ...
    <body>
        <div aligan="center">
            ...
            <form id="testForm" action="ManterOrganizadorController?acao=confirmar${operacao}" method="post" onsubmit="return validarFormulario(this)">
                <table>
                    <tr>
                        <td>Código do Organizador</td> 
                        <td><input type="text" name="idOrganizador" value="${organizador.idOrganizador}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>></td>
                        </tr>
                        <tr>
                            <td>CPF:</td> 
                            <td><input type="text" name="cpf" value="${organizador.cpf}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                        </tr>
                        <tr>
                            <td>Senha:</td> 
                            <td><input type="text" name="senha" value="${organizador.senha}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>  
                </table>
                <center>
