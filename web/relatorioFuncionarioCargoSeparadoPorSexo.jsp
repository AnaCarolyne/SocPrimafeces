            ...
            <table>
                <table>
                    <div style="background-color:#1c5d79;top: 0px;">
                        <h1>Funcionario Com Cargo Separado por Sexo  ${operacao}</h1>
                    </div>

                    <form id="testForm" action="RelatorioFuncionarioCargoSeparadoPorSexo" method="post">

                        <tr> 
                            <td>Sexo do Funcionário</td> 
                            <td>
                                <select name='sexo'>
