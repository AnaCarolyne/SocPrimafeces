...
<html>
    ...
    <body>
        <h1>Pesquisa de Organizador  ${operacao}</h1>

        <table border=1>
            <tr>
                <th>Codigo Organizador</th>
                <th>Cpf</th>
                <th>Senha</th>
            ...
            <c:forEach items="${organizadores}" var="organizador">
                <tr>
                    <td><c:out value="${organizador.idOrganizador}"/></td>
                    <td><c:out value="${organizador.cpf}"/></td>
                    <td><c:out value="${organizador.senha}"/></td>
                    <td><a href="ManterOrganizadorController?acao=prepararEditar&idOrganizador=<c:out value="${organizador.idOrganizador}" />">Editar </a></td>
                    <td><a href="ManterOrganizadorController?acao=prepararExcluir&idOrganizador=<c:out value="${organizador.idOrganizador}" />">Excluir</a></td>
                </tr>      
            </c:forEach>
        </table>
