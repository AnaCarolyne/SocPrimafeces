...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <center>
        <title>Pesquisa de KitProva</title>
       <style type="text/css"> 
    ...
    <body>
        ...
        <h1>Pesquisa de Kit Prova ${operacao}</h1>
         
        <table border=1>
            <tr>
                <th>Codigo KitProva</th>
                <th>Sexo</th>              
                <th>Tamanho</th>
            ...
            <c:forEach items="${kitProvas}" var="kitprova">
                <tr>
                    <td><c:out value="${kitprova.idKitProva}"/></td>
                    <td><c:out value="${kitprova.sexo}"/></td>
                    <td><c:out value="${kitprova.tamanho}"/></td>
                    <td><a href="ManterKitProvaController?acao=prepararEditar&idKitProva=<c:out value="${kitprova.idKitProva}" />">Editar</a></td>
                    <td><a href="ManterKitProvaController?acao=prepararExcluir&idKitProva=<c:out value="${kitprova.idKitProva}" />">Excluir </a></td>
                </tr>      
            </c:forEach>
        </table>
        
       <form action="ManterKitProvaController?acao=prepararIncluir" method="post">  
          <br>
            <br>
             <tr>
