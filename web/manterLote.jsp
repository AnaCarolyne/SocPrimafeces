...
<html>
        <SCRIPT language="JavaScript">
            ...
            function validarFormulario(form) { 
                ...
                if (!campoNumerico(form.idLote.value)){
    ...
    <body>
        <div aligan="center">
                ...
                <form id="testForm" action="ManterLoteController?acao=confirmar${operacao}" method="post">
                    <table>
                        <tr>
                            <td>Código do Lote</td> 
                            <td><input type="text" name="idLote" value="${lote.idLote}" <c:if test="${operacao != 'Incluir'}"> readonly</c:if>></td>
                            </tr>
                            <tr>
                                <td>Data do Começo:</td> 
                                <td><input type="text" name="dataComeco" value="${lote.dataComeco}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                            </tr>
                            <tr>
                                <td>Data do Fim:</td> 
                                <td><input type="text" name="dataFim" value="${lote.dataFim}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                            </tr>
                            <tr>
                                <td> Valor:</td> 
                                <td><input type="text" name="valor" value="${lote.valor}" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>></td>
                            </tr>
                   <tr>
                         <br>   
