...
Exception excecao =(Exception)
	request.getAttribute("javax.servelet.error.exception");
	Integer codigoStatus =(Integer)
	request.getAttribute("javax.servelet.error.status_code");
	String nomeServlet =(String)
	request.getAttribute("javax.servelet.error.servelet_name");
	String uriRequisicao =(String)
	request.getAttribute("javax.servelet.error.request_uri");
	response.setContentType("text/html");
	PrintWriter out = response.getWriter();
	String titulo ="Informação de Exeção";
	String tipoDocto=
	...
	out.println("URI da requisicao: "+uriRequisicao+"</br></br>");
